    ...
    <>
      ...
      <div className="fixed top-0 right-0 h-screen w-12 z-50 hidden md:flex flex-col items-center justify-between py-24 pointer-events-none mix-blend-screen">
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <div className="text-[10px] font-mono text-cyan-400/50 rotate-90 origin-center translate-y-2">TOP</div>
        </div>
      ...
      >
        ...
        >
          ...
          {/* Hexagon Button */}
          <div className="relative w-12 h-12 flex items-center justify-center bg-[#050505] border border-cyan-500/30 hover:border-cyan-400 hover:bg-cyan-900/20 transition-all duration-300 clip-path-hex">
            <ChevronUp size={20} className="text-cyan-400 group-hover:-translate-y-1 transition-transform" />
            
            {/* Spinning Ring */}
            <div className="absolute inset-0 border border-transparent border-t-cyan-400 rounded-full animate-spin-slow opacity-0 group-hover:opacity-100"></div>
          </div>
        </button>
      </motion.div>
